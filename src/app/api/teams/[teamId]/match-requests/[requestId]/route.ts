...
// PATCH /api/teams/[teamId]/match-requests/[requestId]
// 対戦相手募集を締め切る（チームの管理者のみ）
export async function PATCH(
  request: Request,
  { params }: RouteContext<"/api/teams/[teamId]/match-requests/[requestId]">
) {
  ...
  if (!matchRequest || matchRequest.teamId !== teamId) {
    return Response.json({ error: "対戦相手募集が見つかりません" }, { status: 404 })
  }
